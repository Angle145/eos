...
#define OS_STACK_SIZE         512		//用户APP栈内存,单位：word
...
#define STK_CORE_SIZE 		  64		//系统核心栈长度	 (内存使用为N*4) bytes) >=32	（和用户APP数量+软定时器数量有关）	
#define STK_CORE_SLICETIME 	  100		//系统核心响应时间,单位：tick
#define STK_SHELL_SIZE        128		//APP_SHELL栈长度 >150，使用shell插件时有作用
...
#define OS_VALUE_MAX	  	  4	 		//APP同步数值量数量(ID数量)  ，0-255
